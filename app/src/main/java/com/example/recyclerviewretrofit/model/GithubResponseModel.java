package com.example.recyclerviewretrofit.model;
...
public class GithubResponseModel implements Parcelable {
    ...
    protected GithubResponseModel(Parcel in) {
        if (in.readByte() == 0) {
            id = null;
        } else {
            id = in.readInt();
    ...
    public static final Creator<GithubResponseModel> CREATOR = new Creator<GithubResponseModel>() {
        @Override
        public GithubResponseModel createFromParcel(Parcel in) {
            return new GithubResponseModel(in);
        }

        @Override
        public GithubResponseModel[] newArray(int size) {
            return new GithubResponseModel[size];
        }
    };
